...
El videojuego cuenta con un sistema de control adaptado para teclado, permitiendo un movimiento fluido en 8 direcciones y gestión rápida del inventario a través del HUD:
...
## OBJETIVO
El objetivo de la partida es derrotar a todos los enemigos de la forma más rápida posible. Al limpiar habitaciones críticas, desbloquearás armas nuevas de forma automática en tu inventario que te ayudarán a superar los futuros niveles